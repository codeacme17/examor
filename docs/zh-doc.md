...
## 🗒️ 本周开发计划（9/1 - 9/8）
- 稍微沉淀一下，对项目的代码进行重构，从而优化代码的可读性和可扩展性
- 修复现有的 Bugs ([#33](https://github.com/codeacme17/examor/issues/33))
- 完成填空题的题型开发（如果有时间）
...
> 目前版本（v0.2.1）已支持生成单选题，后续会加入填空题的题型
...
> 
> 在此十分抱歉增添了各位使用软件时的心智负担，以后我会避免直接修改库中的键名！
